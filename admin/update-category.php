<?php include('partials/menu.php'); ?>
    ...
    <div class="main-content">
        <div class="wrapper">
            ...
            <br/><br/>
            <?php 
            //check the whether is set or not
            if(isset($_GET['id']))
            {
                //get the id and other detail
               ...
               $res = mysqli_query($conn,$sql);
                //count the rows to check the whether the id is valid or not
                ...
                if($count==1)
                {
                        ...
                        //redirect to manager category with session message 
                        $_SESSION['no-category-found']="<div class ='error'>Category not fFound</div>";
            ...
            <?php 
                if(isset($_POST['submit']))
                {
                   ...
                   //2.Updating new image if selected
                    //check the whether the image is selected or not
                    if(isset($_FILES))
                    {
                        //get the images details
                        $image_name =$_FILES['image']['name'];
                        //check the whether  the image is available or not
                        if($image_name !="")
                        {
                            //images
                   ...
                   //4 redirect to manager category with message
